        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div class="flex-2">
            <div class="pt-2 relative mx-auto text-gray-600">
              <input class="border-2 border-gray-300 bg-white h-10 px-5 pr-32 rounded-lg text-sm focus:outline-none" type="search" name="search" placeholder="Search" />
          ...
          <div class="hidden lg:flex lg:flex-1 lg:justify-end items-center gap-4">
            ...
            <a class="flex flex-col items-center px-3 py-2 text-custom-blue transition-colors duration-300 transform rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="/favorites">
