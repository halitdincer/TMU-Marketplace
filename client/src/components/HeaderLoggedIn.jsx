        ...
        <div class="pr-20">
          ...
          {isMenuOpen && isMobile && (
            ...
            <div className="absolute top-16 right-4 w-64 bg-white shadow-md rounded-lg py-2 z-50">
              ...
              <a href="/profile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={() => setIsMenuOpen(false)}>My Profile</a>
              <a href="/" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => setIsMenuOpen(false)}>Favorites</a>
              ...
              <a href="/login" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={() => setIsMenuOpen(false)}>Sign Out</a>
            </div>
          )}
        </nav>
      </header>
