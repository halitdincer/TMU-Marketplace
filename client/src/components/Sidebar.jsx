      ...
      {isMobile ? (
        <div class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 py-2 sm:hidden z-10">
          <div class="flex justify-evenly">
            ...
            <a
              class="flex flex-col items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
              href="/"
        ...
        <aside class="flex flex-col justify-between content-center w-32 h-screen px-5 py-10 overflow-y-auto bg-white border-r ">
          ...
          <div class="flex justify-center items-end content-end flex-1">
            <a
              class="flex flex-col items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-700"
              href="#"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
