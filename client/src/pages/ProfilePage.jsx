      ...
      <div class="flex-1">
        ...
        <div className="mx-auto lg:max-w-7xl px-6 lg:px-8">
              ...
              <article className="lg:max-w-md mx-auto bg-white border border-gray-200 shadow-lg rounded-lg overflow-hidden my-5" style={{width: '90%', height: '400px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                <img src={userData.profile_picture} alt={userData.username} style={{borderRadius: '50%', objectFit: 'cover', width: '200px', height: '200px', boxShadow: '0px 0px 10px 2px rgba(0,0,0,0.1)', overflow: 'hidden'}} />
                ...
                <div className="bg-white py-6 sm:py-6">
                  <div className="mx-auto lg:max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 pt-2 sm:mt-5 sm:pt-5 lg:mx-0 lg:max-w-none lg:grid-cols-4">
                      {ads.map((ad) => (
                        ad.owned_by === userData.username && <AdCard key={ad.id} ad={ad} />
                      ))}
                    </div>
                  </div>
                </div>
